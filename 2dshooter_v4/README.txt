...
-   main.py: Enthält die Game Klasse die alle erforderlichen Objekte erzeugt,lädt und verwaltet.(update,load,init,ect..)
-   map.py: Enthält einen Teil des Map-parsers und die Camera Klasse, welche dafür sorgt dass nur ein
    Teil der ganzen Karte gezeichnet wird.
